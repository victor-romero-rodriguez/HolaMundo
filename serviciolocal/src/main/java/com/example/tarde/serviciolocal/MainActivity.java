...
public class MainActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Para trabajar con un servicio en local
        ...
        switch(item.getItemId()){
            ...
            case R.id.action_bind_service:
                // Flag, para indicar como quiero que se produzca esa interación con el Servicio

                // Aquí solo estamos estableciendo en enlace entre el Cliente y el Servicio
